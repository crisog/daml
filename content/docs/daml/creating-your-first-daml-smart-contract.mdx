...
Before you begin, complete the environment setup in [Getting Started](/docs/daml).
...
Now that you have a working contract, learn how to verify it behaves correctly in [Testing your first Daml smart contract](/docs/daml/testing-your-first-daml-smart-contract).
