...
Before you begin, complete the environment setup in [Getting Started](/).
...
sequenceDiagram
  ...
  A->>L: Co-authorize create
  B->>L: Co-authorize create
  L-->>A: Contract active
  L-->>B: Contract active
  A->>L: Exercise Pay
...
Now that you have a working contract, learn how to verify it behaves correctly in [Testing your first Daml smart contract](/docs/testing-your-first-daml-smart-contract).
