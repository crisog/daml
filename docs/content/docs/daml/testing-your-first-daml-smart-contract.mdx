...
In the [previous page](/daml/creating-your-first-daml-smart-contract), you built a `PaymentObligation` contract. Now you will write tests that verify it behaves correctly, including cases where it should reject invalid operations.
...
<Cards>
  <Card title="Contract model and the UTXO pattern" href="/daml/contract-model" />
</Cards>
