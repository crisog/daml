...
In the [previous page](/creating-your-first-daml-smart-contract), you built a `PaymentObligation` contract. Now you will write tests that verify it behaves correctly, including cases where it should reject invalid operations.
